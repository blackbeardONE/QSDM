# Diagnostic script for qsdmplus.exe
...
Write-Host ""
Write-Host "4. Starting qsdmplus.exe..." -ForegroundColor Cyan
Write-Host "   (Capturing output for 5 seconds...)" -ForegroundColor Gray

$process = Start-Process -FilePath ".\qsdmplus.exe" -NoNewWindow -PassThru -RedirectStandardOutput "qsdm_output.txt" -RedirectStandardError "qsdm_error.txt"
