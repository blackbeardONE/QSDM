...
//
// As of this revision, two of the three reserved EvidenceKinds
// have concrete verifiers:
...
//
// The remaining kind (freshness-cheat) is registered with a
// StubVerifier. StubVerifier ALWAYS rejects, so slash
...
func NewProductionDispatcher(cfg ProductionConfig) (*Dispatcher, error) {
	...
	// Freshness-cheat remains stubbed at this revision; ships
	// once BFT-finality observability lands.
