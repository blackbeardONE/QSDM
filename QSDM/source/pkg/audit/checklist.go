...
func defaultItems() []ChecklistItem {
	return []ChecklistItem{
		...
		{ID: "rebrand-02", Category: CatRebrand, Severity: SevHigh, Title: "Env var / header deprecation shim", Description: "QSDM_* env vars and X-QSDM-* HTTP headers remain accepted for one minor version, logged once per process as deprecated; QSDM_* / X-QSDM-* are preferred. Unit tests cover both shapes."},
