...
//
// If QSDM_WASM_PREFLIGHT_MODULE (legacy QSDMPLUS_WASM_PREFLIGHT_MODULE still accepted) is set to
...
func TryPreflightP2PTransactionJSON(sdk *WASMSDK, msg []byte) (bool, error) {
	...
	if p := strings.TrimSpace(envcompat.Lookup("QSDM_WASM_PREFLIGHT_MODULE", "QSDMPLUS_WASM_PREFLIGHT_MODULE")); p != "" {
