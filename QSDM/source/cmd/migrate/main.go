...
func main() {
	...
	if len(os.Args) < 3 {
		...
		fmt.Println("")
		fmt.Println("Example:")
		fmt.Println("  migrate qsdm.db 127.0.0.1 qsdm")
		fmt.Println("  migrate qsdm.db 127.0.0.1,127.0.0.2 qsdm   # multiple hosts")
		fmt.Println("  migrate -stats-only qsdm.db               # row counts + timing, no Scylla")
		fmt.Println("")
