...
| Surface | Status |
|---|---|
| Landing page (`qsdm.tech/`) — capabilities section, unified product nav (Download · Wallet · Capabilities · Mining · Docs · Explorer · Audit · Trust), Hive/CELL/edge/home-gateway messaging aligned to v0.4.3 + Hive 1.3.96 | LIVE (after deploy) |
...
QSDM/deploy/Caddyfile                (CSP `connect-src` + `img-src` +
