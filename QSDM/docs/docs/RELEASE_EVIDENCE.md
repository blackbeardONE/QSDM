...
| `04_govulncheck.txt` | `govulncheck ./...` reachable-call-graph CVE scan. | Should report zero reachable findings. The filter allowlist is intentionally empty after Kad-DHT discovery removal; any finding is a new exposure. |
