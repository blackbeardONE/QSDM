      ...
      items: [
        {
          ...
          inlineMarkdown: [
            ...
            "",
            "For a computer laboratory, walletless Agents send fixed work to a policy-controlled Relay. Mother Hive is the role of the active QSDM Hive, not another client. QSDM Core enforces a 70% contributor-owner, 15% Mother Hive operator, and 15% ecosystem reserve split for accepted, funded Relay batches. The fixed ecosystem reserve is `651a79b2b1790820dd73bda81be24057e1bc27377c1f1117c6db2ab79dc038ea`. Settlement fails closed unless the task pool is funded and the Relay fingerprint is authorized by the task manager. Agents cannot receive arbitrary scripts or shell commands.",
            "",
            "Native apps on the Mother Hive computer can use `http://127.0.0.1:7742` with Hive's private application token to submit bounded CPU, GPU, or RAM jobs and read verified receipts. This is an explicit job API; remote capacity is not presented as ordinary local RAM or a CUDA device to unmodified applications.",
            "",
            "## Console mining",
            "",
