...
#   QSDM_NGC_REPORT_URL     e.g. https://api.qsdm.tech/api/v1/monitoring/ngc-proof
#   QSDM_NGC_INGEST_SECRET  hex string, matches the node's QSDM_NGC_INGEST_SECRET
#
# Optional env vars:
#   QSDM_NGC_PROOF_NODE_ID  free-form label that shows up on trust pages
...
if ($Url)    { $env:QSDM_NGC_REPORT_URL    = $Url }
