...
| **`qsdm-hive-wallet-extension/`** | Chrome/Edge provider that connects HTTPS sites to the active Hive-held wallet through the authenticated native messaging bridge. It holds no private keys. |
