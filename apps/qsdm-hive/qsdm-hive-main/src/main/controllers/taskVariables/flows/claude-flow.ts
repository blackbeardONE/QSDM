  ...
  try {
    ...
    const injectBranding = async (page: Page) => {
      await page.evaluate(() => {
        ...
        if (!document.querySelector('.qsdm-branding')) {
          // Add logo
          const logo = document.createElement('div') as HTMLDivElement;
          logo.className = 'qsdm-logo qsdm-branding';
          logo.innerHTML = `
            <div class="logo">
          ...
          footer.innerHTML = `
            ...
            <div class="text">
              ...
              <span>This page is secured by QSDM Hive, and running 100% on your computer</span>
            </div>
          `;
