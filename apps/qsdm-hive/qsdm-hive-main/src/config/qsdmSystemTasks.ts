...
export const QSDM_MOTHER_HIVE_SETTLEMENT_VERSION = 'qsdm-edge-settlement/v1';
export const QSDM_MOTHER_HIVE_SETTLEMENT_SOURCE = 'qsdm-edge-relay-v2';
export const QSDM_ECOSYSTEM_RESERVE_WALLET =
