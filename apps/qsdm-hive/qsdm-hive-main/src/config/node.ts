...
export const BUNDLER_URL = 'https://arweave.net';

export const RESTORE_QSDM_STATE = true;
export const RESTORE_KOHAKU = RESTORE_QSDM_STATE;
...
export const TASK_CONTRACT_ID = 'QsdmTask11111111111111111111111111111111111';
...
export const MAIN_WALLET_DERIVATION_PATH = "m/44'/501'/0'/0'";
