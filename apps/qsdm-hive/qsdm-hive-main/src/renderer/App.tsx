...
import { CheckSuccessLine } from 'vendor/qsdm-styleguide';
import NiceModal from '@ebay/nice-modal-react';
import React from 'react';
import { Toaster } from 'react-hot-toast';
import { QueryClient, QueryClientProvider } from 'react-query';

import 'vendor/qsdm-styleguide/style.css';
...
import { CanonicalChainWarning, NetworkStatus } from './features/network';
import { NetworkStatusProvider } from './features/network/context/NetworkStatusContext';
import { HiveVersionGate } from './features/version/HiveVersionGate';
