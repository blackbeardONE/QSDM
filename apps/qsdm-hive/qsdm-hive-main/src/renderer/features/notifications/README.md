...
- **Triggering Event:** User's staking balance drops below 5 CELL. Notification repeats for each decrement until balance reaches 1 CELL.
...
- **Banner Triggered:** YES
- **Triggering Event:** User's staking balance gets below 0.5 CELL.
- **Notification Text:** Your staking key is below 1 CELL. Fund now to keep your node in the network.
- **CTA:** Fund Now - triggers Fund staking key flow explained here.
...
- **Notification Text:** You just claimed [# of CELL] CELL for running tasks in the network!
