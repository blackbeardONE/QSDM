...
> = {
  ...
  REFERRAL_PROGRAM: {
    ...
    message:
      'Share QSDM Hive with a referral link. Rewards become claimable after the QSDM Referral Reward Pool is funded.',
    variant: 'INFO',
    notificationBanner: {
  ...
  TOP_UP_MAIN_KEY_CRITICAL: {
    title: 'Low Main Key Balance',
    message: `Your main key is below ${getCellFromBaseUnits(
      CRITICAL_MAIN_ACCOUNT_BALANCE
    )} ${NATIVE_TOKEN_SYMBOL}. Fund now to keep your node working correctly.`,
    variant: 'ERROR',
    notificationBanner: {
  ...
  TOP_UP_MAIN_KEY_CRITICAL_WITH_REWARDS: {
    ...
    message: `Your main key is below ${getCellFromBaseUnits(
      CRITICAL_MAIN_ACCOUNT_BALANCE
    )} ${NATIVE_TOKEN_SYMBOL}. Claim some rewards to keep your node working correctly.`,
    variant: 'ERROR',
    notificationBanner: {
  ...
  TOP_UP_STAKING_KEY_CRITICAL: {
    title: 'Low Staking Key Balance',
    message:
      `Your staking key is below 1 ${NATIVE_TOKEN_SYMBOL}. Fund now to keep your node in the network.`,
    variant: 'ERROR',
    notificationBanner: {
  ...
  BACKUP_SEED_PHRASE: {
    title: 'Back Up Hive Recovery Phrase',
    message: '',
    variant: 'WARNING',
    notificationBanner: {
