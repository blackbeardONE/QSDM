...
also known as a "stake", to run tasks on our network.`}
        ...
        <div className="w-[40vw]">
          <span>
            <Popover
              tooltipContent={`A local operator may offer a one-time ${NATIVE_TOKEN_SYMBOL} grant from a separately funded onboarding treasury.`}
            >
              Request an{' '}
              <button
