...
export function Referral() {
  ...
  const copyReferralLink = () => {
    const referralParagraph = `I just joined QSDM Hive! Turn any computer into a passive income generating node in 5 minutes.

Join me and let's build the future together: https://qsdm.tech?refCode=${referralCode}`;
  ...
  return (
    <div className="font-light text-white">
      ...
      <p>
        With this link, they can claim starter CELL from QSDM Hive. After they
        run a node for 7 days, you’ll get 5 and they’ll get 5 more.
      </p>
