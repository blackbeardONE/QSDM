...
Referral tracking is active; CELL referral rewards become claimable after funding and eligibility checks are enabled: https://qsdm.tech?referrer=${mainAccountPubKey}&refCode=${referralCode}.`;
