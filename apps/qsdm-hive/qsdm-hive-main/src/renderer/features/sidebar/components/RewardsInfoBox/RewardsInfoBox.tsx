    ...
    () => ({
      ...
      [RewardsState.RewardReceived]: (
        <div className="relative flex flex-col items-center">
          ...
          <div className="flex items-center justify-center w-8 h-8 border rounded-full border-green-2 bg-finnieBlue-light-tertiary">
            <Icon
              source={CurrencyMoneyLine}
              className="text-green-2"
              size={20}
              data-testid="reward-received-icon"
            />
          </div>
