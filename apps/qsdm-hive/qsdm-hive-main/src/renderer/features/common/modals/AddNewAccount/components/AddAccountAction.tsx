...
export const AddAccountAction = forwardRef<HTMLDivElement, PropsType>(
  ({ icon, title, description, onClick }, ref) => {
    ...
    const classes = twMerge(
      'w-[700px] min-h-[76px] hover:bg-finnieBlue-light-tertiary active:hover:bg-finnieBlue-light-tertiary flex gap-6 rounded-lg text-white items-center px-5 py-3 cursor-pointer',
