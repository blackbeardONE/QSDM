      ...
      >
        ...
        <div className="w-[668px] leading-8 ">
          <p>
            ...
            To submit this list, the node must have some {NATIVE_TOKEN_SYMBOL}{' '}
            in its staking account.
          </p>
          <div className="h-2" />
          <p>
            For now, just 0.5 {NATIVE_TOKEN_SYMBOL} in the staking account is
            plenty to make sure you don’t pay to submit. The node that submits
            the list earns a larger percentage of the bounty.
          </p>
        </div>
