      ...
      <div className="text-white ">
        <div className="flex justify-between p-3">
          <div className="flex items-center justify-between gap-6 pl-6">
            ...
            <span className="text-[24px]">Import Hive key file</span>
          </div>
          <Icon
            source={CloseLine}
        ...
        <div className="flex flex-col w-full p-4 px-14">
          <p className="text-white text-left text-base leading-8 mb-4">
            Import an existing Hive JSON key file here. QSDM Core signer
            keystores are managed by QSDM Core and are not imported through this
            legacy Hive key-file path.
          </p>
          <input
